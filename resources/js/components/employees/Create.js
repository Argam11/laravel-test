                            ...
                            <div className="card-body">
                                <form method="post"  onSubmit={this.createFunction} encType="multipart/form-data">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" name="name" onChange={this.handleChangeFirstName} />
                                    </div>
                                    <div className="form-group">
                                        <label htmlFor="name">Lastname: </label>
                                        <input type="text" className="form-control" name="name" onChange={this.handleChangeLastName} />
                                    </div>
                                    <div className="form-group">
